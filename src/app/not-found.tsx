  ...
  return (
    <div className="min-h-screen grid place-items-center bg-cream-50 p-6">
      <div className="text-center max-w-md">
        <div
          className="mx-auto h-16 w-16 rounded-2xl bg-coffee-gradient grid place-items-center text-cream-50 shadow-coffee bg-cover bg-center"
          data-brand-logo
        >
          <Coffee className="h-8 w-8" data-brand-logo-icon />
        </div>
